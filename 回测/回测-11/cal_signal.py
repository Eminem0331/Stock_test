...
class CalSignal(object):
    def __init__(self, start_date, end_date):
        ...
        df.to_csv(self.path+'1.csv')
        self.start_date = start_date
        self.end_date = end_date
        # rolling时最少存在的数据比例
        self.tolerance_rate = 0.7
        self.data = pd.read_csv(self.path+'1.csv')
...
if __name__ == '__main__':
    ...
    # cal.status2(5, 10, 20, 3, 3, 20)
    # cal.status3(5, 10, 20, 3, 20,3,0.5)
    # cal.status4(5, 10, 20, 3, 3, 20)
    # cal.status5(5, 10, 20, 3, 3, 20)
    # cal.status6(5,10,20,3,3,20)
    # cal.status7(5, 10, 20, 20)
